...
els.employeeForm.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    if (els.employeeDialog.open) els.employeeDialog.close();
    window.requestAnimationFrame(() => els.employeeDialog.close());
...
els.leaveForm.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    window.requestAnimationFrame(() => els.leaveDialog.close());
